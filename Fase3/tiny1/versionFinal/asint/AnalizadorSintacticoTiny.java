...
public class AnalizadorSintacticoTiny {
	...
	public static class InstruccionAsig extends Instr {
		...
		public Exp expresion_iz() {
			return expresion_iz;
		}

		public Exp expresion_der() {
	...
	public static class InstruccionIfElse extends Instr {
		...
		public Instrs instrs_if() {
			return instrs_if;
		}

		public Instrs instrs_else() {
			return instrs_else;
		}
	...
	public static class Boolean extends Exp {
		...
		public StringLocalizado booleano() {
			return bool;
		}
	...
	public static class Acceso_registro_punto extends Exp {

		private StringLocalizado str;
		private Exp arg0;

		public Acceso_registro_punto(Exp arg0, StringLocalizado str) {
			super();
			this.arg0 = arg0;
			this.str = str;
		}
	...
	public static class Acceso_registro_flecha extends Exp {

		private StringLocalizado str;
		private Exp arg0;

		public Acceso_registro_flecha(Exp arg0, StringLocalizado str) {
			super();
			this.arg0 = arg0;
			this.str = str;
		}
	...
	public Exp acceso_registro_punto(Exp arg0, StringLocalizado str) {
		return new Acceso_registro_punto(arg0, str);
	}

	public Exp acceso_registro_flecha(Exp arg0, StringLocalizado str) {
		return new Acceso_registro_flecha(arg0, str);
	}
