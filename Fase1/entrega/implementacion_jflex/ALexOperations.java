...
public class ALexOperations {
	...
	public UnidadLexica unidadNumEntero() {
		return new UnidadLexicaMultivaluada(alex.fila(), alex.columna(), ClaseLexica.NUMENTERO, alex.lexema());
	}
	...
	public UnidadLexica unidadBoolean() {
		return new UnidadLexicaMultivaluada(alex.fila(), alex.columna(), ClaseLexica.BOOLEAN, alex.lexema());
	}
	...
	public UnidadLexica unidadParAbierto() {
		return new UnidadLexicaUnivaluada(alex.fila(), alex.columna(), ClaseLexica.PARABIERTA);
	}

	public UnidadLexica unidadParCerrado() {
		return new UnidadLexicaUnivaluada(alex.fila(), alex.columna(), ClaseLexica.PARCERRADA);
	}
	...
	public UnidadLexica unidadCorcheteAbierto() {
		return new UnidadLexicaUnivaluada(alex.fila(), alex.columna(), ClaseLexica.CORCHETEABIERTO);
	}

	public UnidadLexica unidadCorcheteCerrado() {
		return new UnidadLexicaUnivaluada(alex.fila(), alex.columna(), ClaseLexica.CORCHETECERRADO);
	}

	public UnidadLexica unidadLlaveAbierta() {
		return new UnidadLexicaUnivaluada(alex.fila(), alex.columna(), ClaseLexica.LLAVEABIERTO);
	}
